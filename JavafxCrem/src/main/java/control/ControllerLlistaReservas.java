 ...
 * @author garci
 */
public class ControllerLlistaReservas {
    private ViewLlistaReserves llistaReserves ;

    public ControllerLlistaReservas(ViewLlistaReserves llistaReserves) {
     ...
     public void initController(Stage stage){
         ...
         llistaReserves.getExit().setOnAction(new EventHandler<ActionEvent>() {
            @Override
